...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-[#020617] border-t border-gray-200 dark:border-gray-800 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#home" className="text-base text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
                  Home
                </Link>
              </li>
              <li>
                <Link href="#about" className="text-base text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="#services" className="text-base text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
                  Services
                </Link>
              </li>
              <li>
